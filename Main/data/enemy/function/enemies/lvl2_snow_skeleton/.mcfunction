...
execute if score @s enemy.attack_timer matches 40 run function enemy:enemies/lvl2_snow_skeleton/shoot

execute if score @s enemy.attack_timer matches 50 run function enemy:enemies/lvl2_snow_skeleton/shoot

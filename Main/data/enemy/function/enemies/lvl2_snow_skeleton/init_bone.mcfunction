...
scoreboard players operation @s entity.projectile.owner = @n[tag=Enemy.SnowSkeleton] enemy.id

execute as @n[tag=Enemy.SnowSkeleton] at @s anchored eyes positioned ^ ^ ^ run tp @n[tag=Entity.SkeletonBone] ~ ~ ~ ~ ~

...
$execute as @e[tag=!Entity.Bullet] if score @s player.id = @e[type=marker,tag=Entity.Bullet,sort=nearest,limit=1] gun.bullet_owner run damage @e[tag=Event.BulletHit,sort=nearest,limit=1] $(body_damage) gun:bullet by @s

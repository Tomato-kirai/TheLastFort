execute if score @s gun.pattern matches 1 anchored eyes positioned ^ ^ ^ rotated ~-5 ~ run function gun:pre_raycast
execute if score @s gun.pattern matches 2 anchored eyes positioned ^ ^ ^ rotated ~5 ~ run function gun:pre_raycast
